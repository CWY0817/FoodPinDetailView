...
class RestaurantTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let custumFont = UIFont(name:"Rubik-Medium",size:40.0){
            navigationController?.navigationBar.largeTitleTextAttributes = [ NSAttributedStringKey.foregroundColor:UIColor(red:231.0/255.0,green:76.0/255.0,blue:68.0/255.0,alpha:1.0),NSAttributedStringKey.font:custumFont]
        }
    }
